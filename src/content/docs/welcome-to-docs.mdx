...
next: false
hero:
  title: Welcome to ScrewFast Docs
  tagline: Your central hub for streamlined tool guidance, detailed service docs, and project support.
  image:
    # alt: A ScrewFast's Logo
    # dark: ../../images/starlight/maker_logo_dark.svg
    # light: ../../images/starlight/maker_logo_hero.svg
    html: <img src="../../src/images/starlight/maker_logo_dark.svg" alt="Maker logo" class="h-fit aspect-square"/>
  actions:
    - text: Get started
      icon: right-arrow
      variant: primary
